...
import 'package:swdproject/page/thanksyoupage.dart';
...
class _SendMoneyState extends State<SendMoney> {
  ...
  // _sendmoney() async {
  //   var data = {
  //     "sender_email": "nguyenntse151227@fpt.edu.vn",
  ...
  //   var res = await CallTransaction().postData(data, 'transactions');
                      ...
                      itemBuilder: (context, index) {
                        return FadeInRight(
                          ...
                          child: BouncingWidget(
                            ...
                            scaleFactor: 1.5,
                            onPressed: () {
                              editingController.text = _feedbacks[index];
